...
./ext2_cp ./A4-self-test/runs/case18-cp-rm-dir.img ./A4-self-test/traces.txt /folder2
...
./ext2_restore ./A4-self-test/runs/case18-cp-rm-dir.img /folder2/oneblock.txt
